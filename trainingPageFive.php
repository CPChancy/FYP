...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>But the Law Won: What can happen if you break these laws? - Wombat Training Solutions</title>
                ...
                <div class="trainingContainer">
                    <div class="textBox">
                        <h2 class="trainingHeaders">
                            But the Law Won: What can happen if you break these laws?
                        </h2>
                        <p class="trainingText">
                            In the event you break or cause a breach of any of these laws you are liable to the potentially the following:
                        </p><ul class="trainingText">
                            <li>
                                In the extreme life imprisonment
                            </li><li>
                                Severe financial Penalties (Fines)
                            </li><li>
